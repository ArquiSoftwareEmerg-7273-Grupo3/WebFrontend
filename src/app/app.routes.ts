...
} from './content/pages/suscriptions/components/payment-success/payment-success.component';
...
export const routes: Routes = [
  ...
  { path: 'recommendations', component: AnalysisComponent, canActivate: [authenticationGuard] },
